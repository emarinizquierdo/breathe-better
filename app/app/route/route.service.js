...
angular.module('datafestApp')
    .factory('route', function($rootScope, $q, $http, $mdToast, MainMap, geometry) {
        ...
        var _routeUrl = "https://route.cit.api.here.com/routing/7.2/calculateroute.json",
            _appId = "lzk1bU7C0L3BeTq8CXoS", //old"gYYYj0sjcHChxWFG7b9f",
            _appCode = "Vb8olhR7gsqxiZzBHpzmuQ"; //old"EhIhftLkqN7LEVv7bYld4g";
        ...
        _route.getCircular = function(p_distance) {
            ...
            points[0] = new google.maps.LatLng(MainMap.objects.circularPoint.position.lat(), MainMap.objects.circularPoint.position.lng()); // Circle center
