...
class Station(ndb.Model):
    FID = ndb.IntegerProperty(indexed=False)
    StationCod = ndb.IntegerProperty()
    Name = ndb.StringProperty(indexed=False)
    Latitud = ndb.StringProperty(indexed=False)
    Longitud = ndb.StringProperty(indexed=False)
    Latitud_D = ndb.FloatProperty(indexed=False)
    Longitud_D = ndb.FloatProperty(indexed=False)
    MostPollut = ndb.IntegerProperty(indexed=False)
    LessPollut = ndb.IntegerProperty(indexed=False)
    Intermedia = ndb.IntegerProperty(indexed=False)

def UpdateStation(FID, StationCod, Name, Latitud, Longitud, Latitud_D, Longitud_D, MostPollut, LessPollut, Intermedia):
  station = Station(FID=FID, StationCod=StationCod, Name=Name, Latitud=Latitud, Longitud=Longitud, Latitud_D=Latitud_D, Longitud_D=Longitud_D, MostPollut=MostPollut, LessPollut=LessPollut, Intermedia=Intermedia)
  station.put()
  return station
...
def Inflate():
    for station in aux:
        UpdateStation( station["FID"], station["StationCod"], station["Name"], station["Latitud"], station["Longitud"],
                        station["Latitud_D"], station["Longitud_D"], station["MostPollut"], station["LessPollut"],
                        station["Intermedia"])